...
public class GenreAdapter extends RecyclerView.Adapter<GenreAdapter.ViewHolder> {
    ...
    private List<RespGenre> respGenres;


    public GenreAdapter(Context context, List<RespGenre> respGenres){
        this.context = context;
        this.respGenres = respGenres;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final GenreAdapter.ViewHolder viewHolder, int i) {
        final RespGenre respFavMember = respGenres.get(i);
